...
for number in 01 02 03 05 06; do
  case "$number" in
    01) name='testar-dns' ;;
...
[[ "$(paste -sd, "$TMP/executados.log")" == '01,02,03,05,06' ]]
...
echo 'OK: fluxo guiado executa somente os passos de infraestrutura e para no primeiro erro.'
