#!/usr/bin/env bash
# cd ~/OldCode/sind-infra/sind-amazon/lightsail/34.199.171.33/
set -euo pipefail
...
REMOTE_DIR="/home/app_asaclub_org_br/"
LOCAL_DIR="/home/daniel/OldCode/site-old-asaclub/app_asaclub_org_br/"
...
echo "Baixando arquivos do app ASAClub..."
echo "Origem:  $REMOTE_USER@$REMOTE_HOST:$REMOTE_DIR"
echo "Destino: $LOCAL_DIR"
echo ""

# Baixa por rsync todo o conteúdo de /home/app_asaclub_org_br/ para a pasta local.
